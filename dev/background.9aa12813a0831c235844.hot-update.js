...
function connectRemote(remotePort) {
  ...
  engine.push(async (req, res, next, end) => {
    const pageInfo = Object(_bgHelper__WEBPACK_IMPORTED_MODULE_5__["getCurrentPageInfo"])(connections, origin);
    const params = {
      req,
      res,
      next,
...
//# sourceMappingURL=background.9aa12813a0831c235844.hot-update.js.map