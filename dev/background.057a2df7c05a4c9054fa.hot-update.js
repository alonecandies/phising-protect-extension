...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  if (request.type === "get_page_info") {
    const pageInfo = Object(_bgHelper__WEBPACK_IMPORTED_MODULE_5__["getCurrentPageInfo"])(); // eslint-disable-next-line no-undef
...
function connectRemote(remotePort) {
  ...
  const origin = new URL(sender.url).origin; // engine.push(async (req, res, next, end) => {
...
//# sourceMappingURL=background.057a2df7c05a4c9054fa.hot-update.js.map